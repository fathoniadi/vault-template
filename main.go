...
var (
	cfg = struct {
		...
		PathParams    string `flag:"path-params,p" env:"PATHPARAMS" default="" description:"Dynamic path templating. Also configurable via PATHPARAMS. Ex. \"project=website,environment=development\""`
